...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask, token_type_ids, label_ids, label_mask):
...
def ner_load_and_cache_examples(args, tokenizer, mode):
    ...
    dataset = TensorDataset(all_input_ids, all_attention_mask, all_token_type_ids, all_label_ids, all_label_mask)
    return dataset
